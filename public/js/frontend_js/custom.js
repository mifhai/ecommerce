...
$().ready(function(){
	...
	$("#registerForm").validate({
		...
		messages: {
			name: {
				...
				accept: "Nama Harus terdiri dari Huruf tidak angka"
			},
			password: {
				required: "Silahkan Masukkan Password Anda",
				minlength: "Minimal 6 Angka" // <-- removed underscore
			},
			email: {
				required: "Silahkan Masukkan Email Anda",
				email: "Email Yang Anda Gunakan tidak Valid",
	...
	$("#accountForm").validate({
		...
		messages: {
			...
			province_name: {
				required: "Silahkan Masukkan Nama Provinsi Anda",
			},
			kab_kota_name: {
				required: "Silahkan Masukkan Nama Kota/Kabupaten Anda",
			},
			kecamatan_name: {
				required: "Silahkan Masukkan Nama Kecamatan Anda",
			},
			kelurahan_name: {
				required: "Silahkan Masukkan Nama Kelurahan Anda",
			},
			kode_pos: {
				required: "Silahkan Masukkan Kode Pos Anda",
				minlength: "Minimal 5 Angka", // <-- removed underscore
			},

			phone: {
				required: "Silahkan Masukkan No Telp/HP Anda",
				minlength: "Minimal 9 Angka" // <-- removed underscore
			}
		}
	...
	$("#current_pass").keyup(function(){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp=="false"){
					$("#chkPass").html("<font color='red'> Password Salah, Silahkan Cek Kembali!!</font>");
				}else if(resp=="true"){
					$("#chkPass").html("<font color='green'> Password Benar </font>");
				}
			},error:function(){
				alert('Error');
			}
...
function selectPaymentMethod(){
	if($('#paypal').is(':checked') || $('#cod').is(':checked') || $('#transfer').is(':checked')){
		// alert ('checked');

	}else{
		alert ('Pilih Metode Pembayaran yang Kamu Inginkan');
		return false;
	}

...
<div class="container-fluid col-md-10" id="container-wrapper">
    ...
    <h1 class="h3 mb-0 text-gray-800">Update Brands</h1>
        <ol class="breadcrumb">
...
<!-- Form Basic -->
    <div class="card mb-4">
        <div class="card-body">
            <form enctype="multipart/form-data" method="post" action="{{ url('/admin_edit_brands/'.$brandDetails->id) }}">
                {{ csrf_field() }}

                <div class="form-group">
                    <label class="control-label">Nama Brands</label>
                    <div class="controls">
                        <input type="text" class="form-control" name="brand_name" value="{{ $brandDetails->brand_name}}" required>
                    </div>
                </div>
                ...
                <div class="form-group mt-4">
                    ...
                    <img style="width:40px;" src="{{ asset('/images/backend_images/brands/small/'.$brandDetails->image)}}" alt=""><br>
                    @endif
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="hidden" name="current_image_banner" value="{{ $brandDetails->images_banner}}">
                    @if(!empty($brandDetails->image))
                    <img class="mt-3" src="{{ asset('/images/backend_images/brands/banner/small/'.$brandDetails->images_banner)}}" alt=""><br>
                    @endif
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="customControlAutosizing" @if($brandDetails->status=='1') checked @endif name="status" id="status" value="1">

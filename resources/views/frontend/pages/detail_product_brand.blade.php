...
<style type="text/css">
    ...
    .cart_icon img{
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide slider_product" data-ride="carousel" style="padding-top: 55px;">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="shop_content">
                            <div class="shop_bar clearfix">
                                <div class="shop_product_count"><span> {{ $productsAllBrand->count() }} </span> products found</div>
                            ...
                            @foreach ($productsAllBrand as $productmobile)
                                <!-- Shop Content mobile-->
                            ...
                            <div class="product_grid hidden_media">
                                ...
                                @if(count($productsAllBrand) < 1)
                                <div class="alert notfound">
                                  <strong>Product Not Found...</strong>
                                </div>
                                @else

                                @foreach ($productsAllBrand as $product)
                                    @if($product->status=="1")
                                        <!-- Product Item -->

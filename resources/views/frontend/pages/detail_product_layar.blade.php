                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="shop_content">
                            <div class="shop_bar clearfix">
                                <div class="shop_product_count"><span> {{ $productsAllLayar->count() }} </span> products found</div>
                            ...
                            @foreach ($productsAllLayar as $productmobile)
                                <!-- Shop Content mobile-->
                            ...
                            <div class="product_grid hidden_media">
                                ...
                                @if(count($productsAllLayar) < 1)
                                <div class="alert notfound">
                                  <strong>Product Not Found...</strong>
                                </div>
                                @else

                                    @foreach ($productsAllLayar as $product)
                                        <!-- Product Item -->

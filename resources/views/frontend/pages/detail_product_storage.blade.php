                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="shop_content">
                            <div class="shop_bar clearfix">
                                <div class="shop_product_count"><span> {{ $productsAllStorage->count() }} </span> products found</div>
                            ...
                            @foreach ($productsAllStorage as $productmobile)
                                <!-- Shop Content mobile-->
                            ...
                            <div class="product_grid hidden_media">
                                ...
                                @if(count($productsAllStorage) < 1)
                                <div class="alert notfound">
                                  <strong>Product Not Found...</strong>
                                </div>
                                @else

                                @foreach ($productsAllStorage as $product)
                                    @if($product->status=="1")
                                        <!-- Product Item -->

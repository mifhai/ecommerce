...
@section('judul')
    {{-- Product {{ $productsAll['name_product'] }} --}}
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="shop_content">
                                    ...
                                    @foreach ($productsAll as $product)
                                        ...
                                        @if($product->status=="1")
                                            ...
                                            <div class="product_item is_new">
                                                ...
                                                @else
                                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><a href=" {{ $product->product() }} "><img src="http://placehold.it/300x300" alt="{{ $product->name_product }}"></a>
                                                    </div>
                                                @endif
                            ...
                            <div class="pagination-search" style="float:right;">
                                {{ $productsAll->links() }}
                            </div>
